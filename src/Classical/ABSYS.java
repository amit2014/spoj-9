...
class ABSYS {
    ...
    public void begin() {
        ...
        for(int cases = 0; cases<T; cases++){
           String operand1 = i_scan.next();
           i_scan.next();                   //'+'
           String operand2 = i_scan.next();
           i_scan.next();                   //'='
           String ans = i_scan.next();
           if(operand1.contains("machula")) operand1 = String.valueOf(Integer.parseInt(ans)-Integer.parseInt(operand2));
           else if(operand2.contains("machula")) operand2 = String.valueOf(Integer.parseInt(ans)-Integer.parseInt(operand1));
           else ans=String.valueOf(Integer.parseInt(operand1)+Integer.parseInt(operand2));
           o_writ.printLine(operand1 + " + "+operand2+" = "+ans);
        }
    }

    public ABSYS(String[] args) {
