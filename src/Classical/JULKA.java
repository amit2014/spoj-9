...
class JULKA {
    ...
    public void begin(){
        ...
        BigInteger ans;
        for (int T=0;T<10;T++){
            n = new BigInteger(i_scan.nextLine());
            diff = new BigInteger(i_scan.nextLine());
            
            ans = (n.add(diff)).divide(new BigInteger("2"));
            o_writ.printLine(ans);
            o_writ.printLine(ans.subtract(diff));
        }
    }

    public JULKA(String[] args) {
