...
class ONP_suvrat {
    ...
    public static void main(String[] args) {
        ONP_suvrat program = new ONP_suvrat(args);
        program.begin();
        program.end();
    }
    ...
    */
    ...
    public void begin(){
        ...
        Stack<Character> post_fix_stack;
        StringBuilder sb;
        ...
        for (int test_num = 0; test_num<T; test_num++){
            ...
            post_fix_stack = new Stack<Character>();
            ...
            for (int index = 0; index < str_len; index++){
                if(str.charAt(index)=='('){
                    ...
                    //post_fix_stack.push(str.charAt(index));
                }
            }
            o_writ.printLine();
//            while(!post_fix_stack.empty()){
//                o_writ.print(post_fix_stack.pop());
//            }
        }
    }

    public ONP_suvrat(String[] args) {
